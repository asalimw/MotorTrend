...
The third regression will be the stepwise regression in which the choice of predictive variables is carried out by an automatic procedure. Please look at the appendix for the stepwise regression method.
